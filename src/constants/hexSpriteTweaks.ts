...
export const hexSpriteTweaks: Record<string, HexSpriteTweak> = {
  ...
  cavoodle: { dx: 0, dy: 0, scale: 1 },
  "labrador-retriever": { dx: 0, dy: -12, scale: 0.95 },
  "golden-retriever": { dx: 0, dy: -12, scale: 1 },
  "french-bulldog": { dx: 3, dy: -14, scale: 0.70 },
  "german-shepherd": { dx: 2, dy: -7, scale: 0.95 },
  "border-collie": { dx: -2, dy: -8, scale: 0.95 },
  "staffordshire-bull-terrier": { dx: 2, dy: -8, scale: 0.9 },
  groodle: { dx: -2, dy: 56, scale: 3 },
  ...
  labradoodle: { dx: -2, dy: 56, scale: 3 },
  ...
  // Uncommon
  "cocker-spaniel": { dx: 1.5, dy: -13, scale: 0.75 },
  beagle: { dx: 2, dy: -14, scale: 0.82 },
  "miniature-schnauzer": { dx: 3, dy: -13, scale: 0.78 },
  spoodle: { dx: 2, dy: -13.5, scale: 0.80 },
  "australian-shepherd": { dx: 2, dy: -14, scale: 0.86 },
  pug: { dx: 0, dy: -4, scale: 0.9 },
  chihuahua: { dx:1, dy: -6, scale: 0.95 },
  "bichon-frise": { dx: 3, dy: -4, scale: 0.9 },
  boxer: { dx: 5, dy: -5, scale: 0.9 },
  rottweiler: { dx: 2.5, dy: -4, scale: 0.9 },
  ...
  // Rare + Legendary
  "bernese-mountain-dog": { dx: -4, dy: -6, scale: 0.8 },
  "rhodesian-ridgeback": { dx: -11, dy: -5, scale: 0.9 },
  weimaraner: { dx: -12, dy: -5.0, scale: 1 },
  dobermann: { dx: -8.5, dy: -5.5, scale: 0.95 },
  "great-dane": { dx: -4.5, dy: -6, scale: 0.9 },
  ...
  "irish-wolfhound": { dx: 0, dy: 14.5, scale: 1.1 },
  "chow-chow": { dx: 1, dy: 14.5, scale: 1.05 },
  xoloitzcuintli: { dx: 0, dy: 14.5, scale: 1.1 },
};
