        ...
        tabBarIcon: ({ focused }) => {
          if (route.name === "DogdexTab") {
            return (
              <View
                style={{
                  width: compactTabs ? 28 : 30,
                  height: compactTabs ? 28 : 30,
                  alignItems: "center",
                  justifyContent: "center",
                }}
              >
                <AppMark size={compactTabs ? 23 : 26} style={{ opacity: focused ? 1 : isDark ? 0.55 : 0.5 }} />
              </View>
            );
          }
          return (
            ...
            >
              <MaterialCommunityIcons
                ...
                size={route.name === "SpotTab" ? (compactTabs ? 21 : 24) : compactTabs ? 20 : 22}
                color={
                  route.name === "SpotTab"
                    ? isDark
                      ? palette.ink
